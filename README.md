...
Prefer a real app in your Dock over a browser tab? The [`mac-app/`](mac-app) folder packages `index.html` into a native `Feynman Studio.app` using [pywebview](https://pywebview.flowrl.com/) + [py2app](https://py2app.readthedocs.io/) — see [`mac-app/BUILD.md`](mac-app/BUILD.md) for step-by-step build instructions.
